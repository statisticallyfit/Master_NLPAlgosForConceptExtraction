\section{Word2Vec Model} \label{Word2Vec}
...
According to \cref{fig:SkipGram}, the procedure for learning word vectors is: 
\begin{enumerate}
...
\nameref{Appendix_SkipGram} applies the Skip-Gram model to neural translation, using the word embedding concept. 
...
\nameref{Appendix_CBOW} applies the CBOW model to neural translation, using the word embedding concept. 
