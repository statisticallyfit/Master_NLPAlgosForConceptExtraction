\section{Word Embeddings} \label{WordEmbeddings}
...
\subsubsection{Key Concept: Distributed Representation}
...
\subsubsection{The Problem With Context-Free, Static Embeddings}
