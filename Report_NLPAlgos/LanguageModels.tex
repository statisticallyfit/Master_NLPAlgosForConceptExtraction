...
For more information, \nameref{app:Appendix_Backprop} describes key concepts and algorithms for training neural networks to learn parameters. 
...
A bidirectional language model such as in \cref{fig:bidirectionalLM} combines the forward and backward language models and uses maximum likelihood estimation to \emph{jointly} maximize the log likelihood of the forward and backward directions: 
$$
